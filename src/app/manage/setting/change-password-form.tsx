                ...
                render={({ field }) => (
                  <FormItem>
                    <div className='grid gap-3'>
                      ...
                      <Input id='oldPassword' autoComplete='current-password' type='password' className='w-full' {...field} />
                      <FormMessage />
                    </div>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className='grid gap-3'>
                      ...
                      <Input id='password' autoComplete='new-password' type='password' className='w-full' {...field} />
                      <FormMessage />
                    </div>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className='grid gap-3'>
                      ...
                      <Input id='confirmPassword' autoComplete='new-password' type='password' className='w-full' {...field} />
                      <FormMessage />
                    </div>
                  </FormItem>
                )}
