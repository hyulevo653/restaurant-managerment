...
import dishApiRequest from '@/apiRequests/dishes'
...
export default async function Home() {
  ...
  // let userData: AccountResType['data'] 
  try {
    //dish
  ...
  // try {
  //     //user
  //     const userResult = await accountApiRequest.me()
  //     const {
  //       payload: { data }
  //     } = userResult
  //     userData = data
    ...
    <div className='w-full space-y-4'>
      <section className='relative z-10'>
        ...
        <div className='z-9 relative py-10 md:py-20 px-4 sm:px-10 md:px-20'>
          <h1 className='text-center text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold'>Nhà hàng Duc Huy</h1>
